export const gameABI = [
  {
    inputs: [
      { internalType: 'address', name: '_realmToken', type: 'address' },
  ...
  },
  {
    ...
    name: 'ForceDistributionExecuted',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [],
    name: 'MAX_WEEKLY_REWARD_PERCENTAGE',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'calculatePotentialBattleReward',
    outputs: [
      { internalType: 'uint256', name: 'totalReward', type: 'uint256' },
      { internalType: 'uint256', name: 'fee', type: 'uint256' },
      { internalType: 'uint256', name: 'netReward', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'canStartBattle',
    outputs: [
      { internalType: 'bool', name: 'cooldownPassed', type: 'bool' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'weekNumber', type: 'uint256' }],
    name: 'forceDistributeRewards',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'canBattle', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'getCurrentWeekLeaderboard',
    outputs: [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'weekNumber', type: 'uint256' }],
    name: 'getWeekLeaderboardDetails',
    outputs: [
      { internalType: 'address[10]', name: 'players', type: 'address[10]' },
      { internalType: 'uint256[10]', name: 'scores', type: 'uint256[10]' },
      { internalType: 'bool', name: 'distributed', type: 'bool' },
      { internalType: 'uint256', name: 'potentialRewards', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'baseMultiplier', type: 'uint256' },
      { internalType: 'uint256', name: 'stakingMultiplier', type: 'uint256' },
      { internalType: 'uint256', name: 'nftMultiplier', type: 'uint256' },
      { internalType: 'uint256', name: 'activityMultiplier', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'lastBattleTime', type: 'uint256' },
      { internalType: 'uint256', name: 'lastQuestTime', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'realmToken',
    outputs: [
      { internalType: 'contract IRealmToken', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'address', name: '_newServer', type: 'address' }],
    name: 'setGameServer',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_minimumScore', type: 'uint256' },
      {
        internalType: 'uint256',
        name: '_participationThreshold',
        type: 'uint256',
      },
    ],
  ...
  },
  {
    ...
    name: 'setWeeklyRewardPercentage',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'weeklyParticipationThreshold',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
